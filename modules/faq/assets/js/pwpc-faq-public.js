;(function ( $, window, document, undefined ) {
    ...
    Accordionfaq.prototype.init = function () {
        ...
        function updateParentHeight($parentAccordion, $currentAccordion, qty, operation) {
            var $content = $parentAccordion.filter('.pwpc-faq-open').find('> [data-content]'),
                $childs = $content.find('[data-accordion].pwpc-faq-open > [data-content]'),
                $matched;

            if(!opts.singleOpen) {
                $childs = $childs.not($currentAccordion.siblings('[data-accordion].pwpc-faq-open').find('> [data-content]'));
            }

            $matched = $content.add($childs);

            if($parentAccordion.hasClass('pwpc-faq-open')) {
        ...
        function refreshHeight($accordionfaq) {
            if($accordionfaq.hasClass('pwpc-faq-open')) {
        ...
        function closeAccordion($accordionfaq, $content) {
            ...
            if(CSStransitions) {
                ...
                $accordionfaq.removeClass('pwpc-faq-open');
            } else {
        ...
        function openAccordion($accordionfaq, $content) {
            $accordionfaq.trigger('accordionfaq.pwpc-faq-open');
            if(CSStransitions) {
                ...
                $accordionfaq.addClass('pwpc-faq-open');
            } else {
                $content.animate({
        ...
        function closeSiblingAccordions($accordionfaq) {
            ...
            var $siblings = $accordionfaq.siblings('[data-accordion]').filter('.pwpc-faq-open'),
                $siblingsChildren = $siblings.find('[data-accordion]').filter('.pwpc-faq-open');
            ...
            $otherAccordions.removeClass('pwpc-faq-open');
        }
        ...
        function setup() {
            $content.each(function() {
                ...
                if($curr.css('max-height') != 0) {
                    if(!$curr.closest('[data-accordion]').hasClass('pwpc-faq-open')) {
...
jQuery( document ).ready(function($) {
    ...
    $( '.pwpc-faq-main-wrp' ).each(function( index ) {
