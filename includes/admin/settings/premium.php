...
<div class="wrap">
	...
	<h2><?php _e( 'PowerPack - Features', 'powerpack-lite' ); ?></h2><br />

	<div class="pwpcl-notice">
		<a href="https://www.wponlinesupport.com/pricing/?ref=WposPratik" target="_blank">Upgrade</a> a plugin within a minute and unloack many features now!!!
	</div>

	<style>
		.pwpcl-notice{padding: 10px; color: #3c763d; background-color: #dff0d8; border:1px solid #d6e9c6; margin: 0 0 20px 0;}
	...
	<table class="wpos-plugin-pricing-table">
		...
		<thead>
			<tr>
				...
				<th>
					<h2>Premium</h2>
					<p>Gain access to <strong>PowerPack</strong> and <strong>all other products</strong> with a single purchase.</p>
		...
		<tfoot>
			<tr>
				...
				<td>
					<p>Gain access to <strong>PowerPack</strong> and <strong>all other products</strong> with a single purchase.</p>
					<a href="https://www.wponlinesupport.com/pricing/?ref=WposPratik" target="_blank">View Pricing Options</a>
				</td>
			</tr>
		</tfoot>
		...
		<tbody>
			<tr>
				...
				<td>Contains 16 Plugins</td>
				<td>Contains 23 Plugins (<a target="_blank" href="https://www.wponlinesupport.com/wp-plugin/powerpack-wp-online-support/">Know More</a>)</td>
			</tr>
			<tr>
				<th>Designs <span>Designs that make your website better</span></th>
				<td>Each Plugin have 1 design</td>
				<td>Each Plugin have 15+ designs</td>
			</tr>
			<tr>
				<th>Shortcode Parameters <span>Add extra power to the shortcode</span></th>
				<td>Limited Parameters</td>
				<td>Advanced Parameters</td>
			</tr>
			<tr>
				<th>Security <span>Security & Protect WordPress</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Cookie Consent <span>Display GDPR Cookie Consent Notification</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Login Customizer <span>Customize WordPress login screen</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Maintenance Mode <span>Use Maintenance Mode with no hassle</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Before and After Image Slider <span>Compare two images with easyness</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Extra Info Sidebar <span>Display extra information with easy toggle.</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Business Hours Widget <span>Widget to display your business hours</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
				<th>Social Links Widget <span>Display your social profiles</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
